...
const routes: Routes = [
  ...
  { path: 'slider-news', component: SliderPagesComponent,canActivate: [AuthGuard] },
  { path: 'slider-main', component: SliderPagesComponent,canActivate: [AuthGuard] },
  { path: 'slider-pages', component: SliderPagesComponent,canActivate: [AuthGuard] },
  { path: 'slider-banners', component: SliderPagesComponent,canActivate: [AuthGuard] },
